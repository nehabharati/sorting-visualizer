  ...
  for (let i = 0; i < visualizer.length; i++) {
    if (visualizer[i].length === 3) {
      ...
      if (typeof value1 !== 'object') {
        ...
        setTimeout(() => {
          let [[barOne, barOneHeight], [barTwo, barTwoHeight]] = [
            value1,
            value2,
          ];
          if (barTwoHeight < 0) {
            ...
            bars[barTwo].style.backgroundColor = swap;
            bars[barOne].style.height = `${barTwoHeight}px`;
            bars[barOne].style.top =
              0 + (200 - bars[barOne].clientHeight) + 'px';
          }
          if (barOneHeight < 0) {
            barOneHeight *= -1;
            bars[barOne].style.backgroundColor = swap;
            ...
            bars[barTwo].style.backgroundColor = swap;
            bars[barTwo].style.height = `${barOneHeight}px`;
            bars[barTwo].style.top =
              0 + (200 - bars[barTwo].clientHeight) + 'px';
          }
        }, i * 20);
      }
    }
